defmodule Testly.SessionRecordings.Cleaner do
  ...
  def handle_info(:clean, state) do
    ...
    {:ok, deleted_count} =
      Repo.transaction(
        fn ->
          SessionRecordings.get_staled_recording_ids(limit: @delete_batch_size)
          |> SessionRecordings.delete_recordings()
        end,
        timeout: :infinity
      )
    ...
    Logger.info("[RecordingsCleaner] #{deleted_count} recordings are deleted, it took #{duration}")
