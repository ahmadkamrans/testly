...
#     session_recording_created_at = ~N[2000-01-01 10:00:00.000000Z] |> DateTime.from_naive!("Etc/UTC")

#     second_session_recording_created_at = ~N[2000-01-02 15:00:00.000000Z] |> DateTime.from_naive!("Etc/UTC")

#     third_session_recording_created_at = ~N[2000-01-03 11:00:00.000000Z] |> DateTime.from_naive!("Etc/UTC")

#     session_recording = %SessionRecording{
#       id: Ecto.UUID.generate(),
#       created_at: session_recording_created_at
#     }

#     second_session_recording = %SessionRecording{
#       id: Ecto.UUID.generate(),
#       created_at: second_session_recording_created_at
#     }

#     third_session_recording = %SessionRecording{
#       id: Ecto.UUID.generate(),
#       created_at: third_session_recording_created_at
#     }

#     variation =
#       build(:split_test_variation,
#         visits: [
#           build(:split_test_variation_visit, id: visit1_id, session_recording: session_recording),
#           build(:split_test_variation_visit, session_recording: session_recording),
#           build(:split_test_variation_visit,
#             id: visit3_id,
#             session_recording: second_session_recording
#           ),
#           build(:split_test_variation_visit, session_recording: third_session_recording)
#         ]
#       )
